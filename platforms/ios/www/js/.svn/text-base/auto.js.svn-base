...
}).init().bind(document.getElementById('chargerName')).bind(document.getElementById('autoC')); 
function resetSource(str){
	window.autoComObj.source=str.split('|');
}
